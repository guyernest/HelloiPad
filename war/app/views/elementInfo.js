/**
 * @class elements.views.ElementInfo
 * @extends Ext.Sheet
 * 
 * We use this Ext.Sheet subclass to display information about a particular Element when the user has tapped on it.
 ...
 * inside its own function to make it easy to see what is going on. The ElementInfo sheet is rendered and shown by
 * the Element controller's 'show' action (see app/controllers/loans.js).
 * 
 */
elements.views.ElementInfo = Ext.extend(Ext.Sheet, {
    modal: true,
    centered : false,
    hideOnMaskTap : true,
    ...
    initComponent: function() {
        ...
        elements.views.ElementInfo.superclass.initComponent.apply(this, arguments);
    },
    
    /**
     * Sets the Element instance to be displayed in the cards. If this component has already been rendered,
     * the cards are updated immediately, otherwise they will be updated when the component is rendered
     * @param {Ext.data.Model} element The Element instance
     */
    setElement: function(element) {
        /**
         * @property instance
         * @type Ext.data.Model
         * The currently loaded Element instance
         */
    ...
    /**
     * Returns an Ext.Component that displays details about the given Element
    ...
    /**
     * Returns an Ext.Component that displays the payment schedule for the given Element
    ...
    updateCards: function() {
        var detailsCard  = this.down("#detailsCard"),
            ...
            coords       = Element.get('location').geo.pairs.split(' ').map(parseFloat);
        
        //updates the text in the first two cards
        detailsCard.update(Element.data);
        paymentsCard.update(Element.data.terms.scheduled_payments);
        ...
        var url    = "http://www.elements.org/lend/" + this.instance.getId(),
...
Ext.reg('loanShow', elements.views.ElementInfo);